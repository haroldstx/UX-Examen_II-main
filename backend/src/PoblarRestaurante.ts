    ...
    if (Res === 0) {
      const RestaurantesHabilitados = [
        ...
        },
        {
          idHabilitado: 2,
          id: 1,
          scheduleTime: new Date("2023-06-20T08:00:00Z".replace(" ", "T")),
          reserved: false,
          reservedBy: "",
        },
        {
          idHabilitado: 3,
          id: 2,
          scheduleTime: new Date("2023-06-21T10:00:00Z".replace(" ", "T")),
          reserved: false,
          reservedBy: "",
        },
        {
          idHabilitado: 4,
          id: 2,
          scheduleTime: new Date("2023-06-21T11:00:00Z".replace(" ", "T")),
          reserved: false,
          reservedBy: "",
        },
        {
          idHabilitado: 5,
          id: 3,
          scheduleTime: new Date("2023-06-22T07:00:00Z".replace(" ", "T")),
          reserved: false,
          reservedBy: "",
        },
        {
          idHabilitado: 6,
          id: 3,
          scheduleTime: new Date("2023-06-22T09:00:00Z".replace(" ", "T")),
          reserved: false,
          reservedBy: "",
        },
      ];
